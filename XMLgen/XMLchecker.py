...
if not htFile:
  logfile.write(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n")
  logfile.write(">>>>>>>  MISSING  2D historical_target_file:"+htFileName.strip()+"\n")
  logfile.write(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n")
  print(">>>>>>>  MISSING  2D historical_target_file:"+htFileName.strip()+"\n")
  fmissing = True
logfile.write("\n")
k=0
for hpFile in hpFiles:
  ...
  if not hpFiles[k]:
    logfile.write(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n")
    logfile.write(">>>>>>>  MISSING  2D historical_predictor_file:"+hpFileNames[k].strip()+"\n")
    logfile.write(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n")
    print(">>>>>>>  MISSING  2D historical_predictor_file:"+hpFileNames[k].strip()+"\n")
    fmissing = True
  k=k+1
logfile.write("\n")
...
if not fpFile:
  logfile.write(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n")
  logfile.write(">>>>>>>  MISSING   2D future_pedictor_file:"+fpFileName.strip()+"\n")
  logfile.write(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n")
  print(">>>>>>>  MISSING   2D future_pedictor_file:"+fpFileName.strip()+"\n")
  fmissing = True
logfile.write("\n")
if smask!="na":
...
if not htwFile:
  ...
  logfile.write(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n")
  logfile.write(">>>>>>>  MISSING  htwFileName = "+htwFileName.strip()+ " \n")
  logfile.write(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n")
  print(">>>>>>>  MISSING  historical time window FileName = "+htwFileName.strip())
  fmissing = True
logfile.write("\n")
...
if not ftwFile:
  ...
  logfile.write(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n")
  logfile.write(">>>>>>>  MISSING  ftwFileName = "+ftwFileName.strip() + " \n")
  logfile.write(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n")
  print(">>>>>>>  MISSING  future time window FileName = "+ftwFileName.strip())
  fmissing = True
logfile.write("\n")
logfile.write("-------------------------- \n")
...
logfile.write("%%%%%  \n")
logfile.write("\n")
logfile.write("downscaled_output_dir: "+dsArcDir + "\n")
