...
#------------ historical predictor(s)----------# 
	...
	hist.freq_1 <- 'day' 
	hist.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING//GCM_DATA/CMIP5//MPI-ESM-LR/historical/day/atmos/day/r1i1p1/v20111006/pr/SCCSC0p1/OneD/' 
...
#------------ future predictor(s) -------------# 
	...
	fut.freq_1 <- 'day' 
	fut.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING//GCM_DATA/CMIP5//MPI-ESM-LR/rcp45/day/atmos/day/r1i1p1/v20111006/pr/SCCSC0p1/OneD/'
...
#------------- target -------------------------# 
	...
	target.freq_1 <- 'day' 
        target.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING//OBS_DATA/GRIDDED_OBS//livneh/historical/day/atmos/day/r0i0p0/v1p2/pr/SCCSC0p1/OneD/'
...
gcp_to_TMPDIR <- function(TMPDIR, directory, file.str=""){
  if((grepl('^/archive',directory)) | (grepl('^/work',directory))){
	...
	message('investigating a gcp, since there is nothing here')
	message(directory.tmp)
