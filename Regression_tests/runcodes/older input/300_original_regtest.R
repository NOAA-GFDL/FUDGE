...
#------------- method name k-fold specs-----------------------#
	...
	k.fold <- 0 
#pr_opts=list(opt_wetday='zero',lopt_drizzle='on',lopt_conserve='off')
#-------------- output -----------------------#
#	output.dir <- '<TMPDIR>/home/cew/Code/testing/'
##	mask.output.dir <- '/home/cew/Code/testing/tasmax_qcmask/' 
#mask.output.dir <- '<TMPDIR>/home/cew/Code/testing/QCMask/' 
# output.dir <- '/home/cew/Code/testing/test_output_for_cmndfile'
output.dir <- <OUTPUT_DIR>
 #	mask.output.dir <- '/home/cew/Code/testing/tasmax_qcmask/' 
 mask.output.dir <- '/home/cew/Code/testing/test_output_for_cmndfile/QCMask/' 
#-------------  custom -----------------------#
        args=list(dev=2,npas=300) 
 #Number of "cuts" for which quantiles will be empirically estimated (Default is 100 in CDFt package).
#-------------- pp ---------------------------#
#        mask.list <- list(mask1=list(type='SBiasCorr',adjust.out='on',qc.mask='on'))
#mask.list <- list(mask1=list(type='Nothing',adjust.out='off',qc.mask='off'))
#mask.list <- list(mask1=list(type='SBiasCorr',adjust.out='on',qc.mask='on',qc_options=list(botlim=-6.0,toplim=6.0)))
mask.list <- 'na'
################### others ###################################
