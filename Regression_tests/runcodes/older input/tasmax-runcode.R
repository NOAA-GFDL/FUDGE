...
#------------ historical predictor(s)----------# 
	...
	hist.freq_1 <- 'day' 
	hist.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING///GCM_DATA/CMIP5//MPI-ESM-LR/historical//atmos/day/r1i1p1/v20120705/tasmax/SCCSC0p1/OneD/' 
...
#------------ future predictor(s) -------------# 
	...
	fut.freq_1 <- 'day' 
	fut.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING///GCM_DATA/CMIP5//MPI-ESM-LR/rcp45//atmos/day/r1i1p1/v20111014/tasmax/SCCSC0p1/OneD/'
...
#------------- method name k-fold specs-----------------------#
        ds.method <- 'CDFt' 
	ds.experiment <- 'RRtxp1-CDFt-B38ap-testL01K00' 
	k.fold <- 0 
	#pr_opts=list(pr_threshold_in='us_trace',pr_freqadj_in='off',pr_conserve_in='on',pr_threshold_out='us_trace',pr_conserve_out='off')
#-------------- output -----------------------#
