...
#------------- method name k-fold specs-----------------------#
        ds.method <- 'CDFt' 
	ds.experiment <- 'RRprp1-CDFt-B38ap-testL01K00' 
	k.fold <- 0 
	pr_opts=list(pr_threshold_in='us_trace',pr_freqadj_in='off',pr_conserve_in='on',pr_threshold_out='us_trace',pr_conserve_out='on')
#-------------- output -----------------------#
	output.dir <- '/work/cew//downscaled/NOAA-GFDL/MPI-ESM-LR/rcp85/day/atmos/day/r1i1p1/v20111014/RRprp1-CDFt-B38ap-testL01K00/pr/RR/OneD/v20140108/'
	mask.output.dir <- '/work/cew//downscaled/NOAA-GFDL/MPI-ESM-LR/rcp85/day/atmos/day/r1i1p1/v20111014/RRprp1-CDFt-B38ap-testL01K00/pr/RR/OneD/v20140108//pr_qcmask/' 
#-------------  custom -----------------------#
