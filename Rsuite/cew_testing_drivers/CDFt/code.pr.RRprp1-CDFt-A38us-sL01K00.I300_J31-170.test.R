...
#------------- method name k-fold specs-----------------------#
        ds.method <- 'CDFt' 
	ds.experiment <- 'RRprp1-CDFt-A38us-sL01K00' 
	k.fold <- 0 
#-------------- output -----------------------#
	output.dir <- '/work/cew//downscaled/NOAA-GFDL/MPI-ESM-LR/rcp85/day/atmos/day/r1i1p1/v20111014/RRprp1-CDFt-A38us-sL01K00/pr/RR/OneD/v20140108/'
#-------------  custom -----------------------#
        #args=list('na')
       #args=list(npas=300, time.trim.mask='/archive/esd/PROJECTS/DOWNSCALING/3ToThe5th/masks/timemasks/maskdays_bymonth_20060101-20991231.nc')
args=list(time.trim.mask='/archive/esd/PROJECTS/DOWNSCALING/3ToThe5th/masks/timemasks/maskdays_bymonth_20060101-20991231.nc')
