...
hist.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING///GCM_DATA/CMIP5//MPI-ESM-LR/historical//atmos/day/r1i1p1/v20111006/pr/SCCSC0p1/OneD/'
	hist.time.window <- '/archive/esd/PROJECTS/DOWNSCALING/3ToThe5th/masks/timemasks/maskdays_annual_19610101-20051231.nc' 
#------------ future predictor(s) -------------# 
	...
	fut.time.window <- '/archive/esd/PROJECTS/DOWNSCALING/3ToThe5th/masks/timemasks/maskdays_annual_20060101-20991231.nc'
...
#------------- target -------------------------# 
	...
	target.time.window <- '/archive/esd/PROJECTS/DOWNSCALING/3ToThe5th/masks/timemasks/maskdays_annual_19610101-20051231.nc' #r0i0p0 #0p1
#------------- method name k-fold specs-----------------------#
        ds.method <- 'CDFt' 
	ds.experiment <- 'testing-noopts.pr-1pow5-txp1-GFDL-CDFtv1-A00X01K00' 
	k.fold <- 0 
#-------------- output -----------------------#
	#output.dir <- '/work/a1r/PROJECTS/DOWNSCALING/3ToThe5th//downscaled/NOAA-GFDL/MPI-ESM-LR/rcp85_r1i1p1//atmos/day/r1i1p1/v20111014/1pow5-txp1-GFDL-CDFtv1-A00X01K00/pr/SCCSC0p1/OneD/v20140108/'
