...
#------------- method name k-fold specs-----------------------#
        ds.method <- 'DeltaSD' 
	ds.experiment <- 'PMtasmaxAnomp1-DeltaSD-AXXq-aL01K00' 
	k.fold <- 0 
	
#-------------- output -----------------------#
	output.dir <- '/work/cew//downscaled/NOAA-GFDL/BOGUS/amip/day/atmos/anomSbx7C360LR/r1i1p1/v1/PMtasmaxAnomp1-DeltaSD-AXXq-aL01K00/tasmaxAnom/US48/OneD/v20140108/'
	mask.output.dir <- '/work/cew//downscaled/NOAA-GFDL/BOGUS/amip/day/atmos/anomSbx7C360LR/r1i1p1/v1/PMtasmaxAnomp1-DeltaSD-AXXq-aL01K00/tasmaxAnom/US48/OneD/v20140108//tasmaxAnom_qcmask/' 
#-------------  custom -----------------------#
        args=list('na') 
