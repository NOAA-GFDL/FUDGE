...
#------------- method name k-fold specs-----------------------#
        ds.method <- 'CDFt' 
	ds.experiment <- 'RRtnp1-CDFt-B38btL01K00' 
	k.fold <- 0 
	
#-------------- output -----------------------#
	output.dir <- '/work/cew//downscaled/NOAA-GFDL/MPI-ESM-LR/rcp85/day/atmos/day/r1i1p1/v20111014/RRtnp1-CDFt-B38btL01K00/tasmin/RRtest/OneD/v20140108/'
	mask.output.dir <- '/work/cew//downscaled/NOAA-GFDL/MPI-ESM-LR/rcp85/day/atmos/day/r1i1p1/v20111014/RRtnp1-CDFt-B38btL01K00/tasmin/RRtest/OneD/v20140108//tasmin_qcmask/' 
#-------------  custom -----------------------#
        args=list(npas=300,dev=1) 
 #Number of "cuts" for which quantiles will be empirically estimated (Default is 100 in CDFt package).
#-------------- pp ---------------------------#
        mask.list <- list(mask1=list(type='SBiasCorr',adjust.out='off',qc.mask='on',qc_options=list(botlim=-6.0,toplim=6.0)))
################### others ###################################
