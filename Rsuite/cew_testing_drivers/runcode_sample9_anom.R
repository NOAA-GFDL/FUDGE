...
#------------ historical predictor(s)----------# 
	...
	hist.freq_1 <- 'day' 
	hist.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING//GCM_DATA/NCPP//GFDL-HIRAM-C360-COARSENED/amip/day/atmos/PManom1979-2008Sbx7/r1i1p1/v20110601/tasmaxAnom/US48/OneD/' 
	hist.time.window <- '/archive/esd/PROJECTS/DOWNSCALING/3ToThe5th/masks/timemasks/maskdays_bymonth_19790101-20081231.nc' 
#------------ future predictor(s) -------------# 
	...
	fut.time.window <- '/archive/esd/PROJECTS/DOWNSCALING/3ToThe5th/masks/timemasks/maskdays_bymonth_20860101-20951231.nc'
...
#------------- target -------------------------# 
	...
	target.freq_1 <- 'day' 
        target.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING//GCM_DATA/NCPP//GFDL-HIRAM-C360/amip/day/atmos/PManom1979-2008Sbx7/r1i1p1/v20110601/tasmaxAnom/US48/OneD/'
...
#------------- method name k-fold specs-----------------------#
        ds.method <- 'EDQM_DF' 
	ds.experiment <- paste("TCtxanp1", ds.method, 'A1e1TestX01K00', sep="-") 
	k.fold <- 0 
